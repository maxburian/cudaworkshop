...
//         printf("Using device %d\n", device);
    ...
    cudaMemAdvise(a, m , cudaMemAdviseSetReadMostly,device);
    cudaMemAdvise(c, m , cudaMemAdviseSetReadMostly,device);
    
    cudaMemPrefetchAsync(a,m,device);
    cudaMemPrefetchAsync(c,m,device);
