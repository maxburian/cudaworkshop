...
template <int BLOCK_THREADS, int ITEMS_PER_THREAD, BlockLoadAlgorithm LOAD_ALGO, typename T>
...
int main(){
    ...
    // Call the kernel
    ExampleKernel<1024, 4, BLOCK_LOAD_TRANSPOSE><<<1, 1024>>>(d_gpu, result_gpu);
